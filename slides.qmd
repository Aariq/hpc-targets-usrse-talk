...
[![nanonext](https://shikokuchuo.net/nanonext/logo.png){alt="nanonext" style="vertical-align:middle;" width="75" height="88"}](https://shikokuchuo.net/nanonext/) `nanonext`, R bindings for [NNG](https://nng.nanomsg.org/) (Nanomsg Next Gen), which powers...

. . .

[![mirai](https://shikokuchuo.net/mirai/logo.png){style="vertical-align:middle" width="75"}](https://shikokuchuo.net/mirai/) `mirai`, a "minimalist async evaluation framework for R", which powers ...

. . .

[![](https://wlandau.github.io/crew/logo.svg){style="vertical-align:middle" width="75"}](https://wlandau.github.io/crew/) `crew`, a unifying interface for creating distributed worker launchers
